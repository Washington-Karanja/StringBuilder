...
import { clientBrands, disciplines, industries, principles } from "@/content/about";
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {clientBrands.map((brand, index) => (
              <div key={`${brand.name}-${index}`} className="flex items-center gap-4 rounded-2xl border border-border bg-card p-6 shadow-soft">
